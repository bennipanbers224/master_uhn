              ...
              <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <tr>
                        <th>Judul Berita</th>
                        <td>
                          <input name="judul" type="text" class="form-control" id="exampleInputEmail1" placeholder="Judul Berita">
                        </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                          <div class="input-group">
                            ...
                            <input name="date_release" type="date" class="form-control float-right" id="reservation">
                          </div>
                        </td>
                    </tr>
                    </thead>
